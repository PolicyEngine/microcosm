# Lane D: graph runtime release semantics and parity
...
- Read the charter, frozen declarations/protocol, exact F/H/replay tests, toy kernels, executor, and manifest in the required order.
