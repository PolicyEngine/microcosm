...
Each execution directory supplies the adapter case available in that
environment; the test classes below remain one shared contract.
"""
...
_FIXTURE_RULESPEC_ROOT = _TEST_PATHS.tests / "fixtures" / "rulespec-zz"
...
POLICYENGINE_US_CASE = AdapterCase(
