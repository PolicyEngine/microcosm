...
The finite roster has 58 pure cases, 50 graph cases and 14 actual-owner cases. The current qualifier is bounded to 2,097,152 original persons, and a graph artifact is bounded to 64 MiB. Those limits have not been validated against a full national original universe; a larger build needs a reviewed storage and resource plan rather than silently increasing them.
