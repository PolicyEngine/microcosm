...
print(
    "expected masked _data:",
    expected.frame.person["nullable_integer"].array._data.tolist(),
)
print(
    "actual   masked _data:",
    actual.frame.person["nullable_integer"].array._data.tolist(),
)
try:
    same_replayed_population(expected, actual)
    print("same_replayed_population: ACCEPTS")
except ValueError as e:
    print("same_replayed_population: REFUSES", e)
