...
``packages/microcosm-frame/tests/test_contracts.py``
...
from microcosm.fit import NO_WEIGHTS, fit
...
def test_weighted_fit_shifts_draws_toward_weighted_truth(
    ...
    Realizes the kernel's skipped microcosm-fit contract. The donor target is
