...
These tests pin the operator's defining rule (DESIGN.md, "microcosm-fit"): a fit
...
from microcosm.fit.model import predictors_targets_entity, resolve_fit_weights
