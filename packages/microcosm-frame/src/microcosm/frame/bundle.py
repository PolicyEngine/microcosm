...
entities declared by its :class:`~microcosm.frame.schema.EntitySchema`), typed
...
class Frame:
    ...
    the microcosm stack takes a frame and returns a frame.
    ...
    Args:
        ...
        schema: The entity structure (see
            :class:`~microcosm.frame.schema.EntitySchema`).
    ...
    def mass_log(self) -> tuple[MassChangeRecord, ...]:
        ...
        Each :class:`~microcosm.frame.weights.MassChangeRecord` is one
    ...
    def weights_for(self, entity: str) -> Weights:
        ...
        Returns:
            The stored :class:`~microcosm.frame.weights.Weights`.
    ...
    def resolve_weights(self, entity: str) -> Weights:
        ...
        *effective* weights and preserves their kind: an entity without its own
        ...
        that source entity's :class:`~microcosm.frame.weights.WeightKind`. This
        ...
        Returns:
            The effective :class:`~microcosm.frame.weights.Weights` for
    ...
    def with_weights(
        ...
        * a :class:`~microcosm.frame.weights.MassChange` — declares an
        ...
        Args:
            ...
            mass: The mass policy — :data:`CONSERVE_MASS` or a
                :class:`~microcosm.frame.weights.MassChange`. Required.
