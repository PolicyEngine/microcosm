...
def test_microcosm_is_a_namespace_package() -> None:
    """No shard ships a top-level microcosm/__init__.py (PEP 420).
...
@pytest.mark.skip(reason="microcosm-fit not yet in workspace")
def test_weighted_fit_shifts_draws_toward_weighted_truth() -> None:
    """Contract for the microcosm-fit conditional-models operator.
