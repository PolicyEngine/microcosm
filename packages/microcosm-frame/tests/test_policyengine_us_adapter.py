...
a workspace dependency; install via ``microcosm-frame[policyengine]`` to run
these).
"""
...
from microcosm.frame.adapters.policyengine_us import PolicyEngineUSEngine  # noqa: E402
...
class TestTakeUpContract:
    """Take-up variable discovery and classification (microcosm #312)."""
