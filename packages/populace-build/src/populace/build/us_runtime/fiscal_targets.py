...
US_FISCAL_TARGET_SUPPORT_EXCLUSIONS: dict[str, str] = {
    ...
    "irs_soi.ty2022.historic_table_2.state_agi.vt.under_1.taxable_interest_amount": (
        ...
        "selection, frame identity b54feb926c6e5396…, release populace- "
        "us-2024-buildp-dense-cae8640-20260728T050443Z): registry aggregates "
        ...
        "positive carriers pool-wide — the cell is unexpressible from the pool "
