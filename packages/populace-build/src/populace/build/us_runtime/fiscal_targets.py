...
US_FISCAL_TARGET_SUPPORT_EXCLUSIONS: dict[str, str] = {
    "irs_soi.ty2023.table_1_4.all.other_income_net_loss_amount": (
        ...
        "A1), not the Schedule-1 line-21 'other income' concept SOI Table 1.4 "
        "reports — populace#393's remedy experiments reached this final "
        ...
        "mismatched, and the measured legs bear the 4797 reading: raw ty2015 "
        "E01200 is two-sided ($22.84B positive on 1.09M returns vs $21.55B "
        "negative on 1.18M) while SOI ty2015 other income is heavily positive "
        ...
        "excluded until the populace#393 remedy lands: remap E01200 to "
        "other_net_gain, rebuild the processed PUF, and separately source true "
        "line-21 miscellaneous income; these exclusions lift with that rebuild."
    ),
    "irs_soi.ty2023.table_1_4.all.other_income_net_loss_returns": (
        ...
        "until the populace#393 remedy (remap E01200 to other_net_gain and "
        "rebuild) lands; see the loss-amount entry for the full adjudication."
    ),
