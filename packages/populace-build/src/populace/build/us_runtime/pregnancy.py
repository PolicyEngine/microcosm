...
unsourced-exemption-input failure mode of populace #351.
...
rates were unavailable. Populace builds are hermetic — no live CDC/ACS
...
def us_pregnancy_signal_gate(frame: Frame) -> GateResult:
    ...
    inverting) the nobody-is-ever-pregnant failure of populace #351.
    """
