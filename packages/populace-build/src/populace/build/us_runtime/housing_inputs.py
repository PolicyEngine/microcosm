...
Populace preserves those source semantics and uses its shared design-weighted
...
def load_acs_2022_rent_donor(
    ...
    *,
    ...
    # sampler.  The retired unweighted fit retained them; Populace's deliberate
...
def impute_us_housing_assistance_to_puf_support(
    ...
    *,
    seed: int,
    n_estimators: int = _DEFAULT_N_ESTIMATORS,
    max_train_samples: int = _PUF_MAX_TRAIN_SAMPLES,
) -> Frame:
