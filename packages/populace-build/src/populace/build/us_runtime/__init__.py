...
from populace.build.us_runtime.child_disability import (
...
US_DONORS: Mapping[str, DonorSpec] = {
    ...
    US_CHILD_DISABILITY_STAGE_NAME: DonorSpec(
        survey="Census SIPP 2023",
        source="https://www.census.gov/programs-surveys/sipp.html",
        notes=(
            "December functional-difficulty responses train the weighted "
            "age-5--14 classifier; ages 0--4 use the explicitly labeled SSA "
            "caseload-allocation target from populace#453."
        ),
    ),
