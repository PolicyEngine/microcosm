...
Populace calibrates congressional-district (CD) fiscal targets from the IRS SOI
CD table, whose district geography is the **117th Congress** (the pre-2020-
apportionment plan, drawn on 2010 geography). The current Populace CD surface
...
- **Weight**: 2020 P.L. 94-171 ``POP100`` per block (the block ladder's
  :func:`~populace.build.us_runtime.block_ladder_sources.parse_pl_geo_blocks`
...
#: Non-voting delegate districts (DC) — the district-00 rung of the Populace
