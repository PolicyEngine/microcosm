...
but nothing checked the registers against EACH OTHER. populace #377 is the
...
preflight instead (populace #377 acceptance criteria).
"""
...
from populace.build.us_runtime.parity_reference import load_ecps_parity_known_gaps
