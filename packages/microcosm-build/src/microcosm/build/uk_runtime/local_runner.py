"""Reusable runner pieces for Microcosm-owned UK local builds.

The core local-geography modules deliberately avoid data-package imports:
target providers hand Microcosm explicit area tables, and engine runners hand it
...
def build_local_candidate_from_dataset(
    ...
    *,
    ...
    """Build a UK local candidate from a Microcosm UK H5 or dataset object."""
