...
:func:`microcosm.build.uk_runtime.local_solver.solve_stacked_local_weights`
...
carries the microcosm#492 past-cap census so written-off rows are first-class
diagnostics.
...
from microcosm.build.uk_runtime.local_geography import StackedLocalMatrix
