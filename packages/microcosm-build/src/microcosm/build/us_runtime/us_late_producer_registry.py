...
# implicit. Receipt v4 requires every bounded transfer producer to carry exact
# realized QRF regimes and reconstructs the aggregate regime receipt from those
# nineteen producer receipts. Receipt v3 reconciled repeated physical evidence and scope
    ...
    return {
        ...
        "execution_receipt_contract": {
            ...
            "top_binding": (
                ...
                "completion_and_nineteen_transfer_groups_with_exact_"
                "realized_regime_reconstruction"
            ),
