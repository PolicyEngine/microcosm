...
The ``snap_take_up`` stage (microcosm #243) anchors take-up on reported ASEC
...
def us_snap_state_take_up_diagnostics(
    ...
    return {
        ...
        "issues": ["microcosm#372", "microcosm#243"],
        "variable": US_SNAP_TAKE_UP_OUTPUT_COLUMN,
