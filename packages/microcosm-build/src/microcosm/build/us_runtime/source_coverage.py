...
This is a pinned Microcosm-side copy of the Ledger source coverage contract
merged in ``PolicyEngine/ledger-data`` commit
``e2fc882c35f9203c788a7159e7b08b0b5e5ceb58``. Ledger owns source packages;
Microcosm owns whether source families are active hard targets, validation-only
