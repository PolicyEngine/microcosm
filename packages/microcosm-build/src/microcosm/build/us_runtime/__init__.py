...
# Explicit compatibility targets: no discovery or source parsing at runtime.
_EXPORT_MODULES = {
    ...
    "microcosm.build.us_runtime.alimony": (
        "ALIMONY_ASEC_ARCHIVED_DERIVATION_URL",
        "ALIMONY_PUF_ARCHIVED_DERIVATION_URL",
        "STRIKE_BENEFITS_ASEC_ARCHIVED_DERIVATION_URL",
        "US_ALIMONY_NONCONSTANT_PERSON_COLUMNS",
    ...
    "microcosm.build.us_runtime.asec_checkpoint": (
        "ASEC_RAW_STAGE_ARTIFACT_KIND",
        "ASEC_RAW_STAGE_CHECKPOINT_FILENAME",
        "ASEC_RAW_STAGE_COVERAGE_SCHEMA_VERSION",
        "ASEC_RAW_STAGE_OPERATOR_STATUS",
    ...
    "microcosm.build.us_runtime.asec_pool": (
        "AsecSource",
        "build_pooled_asec_unit_frame",
        "load_asec_h5_tables",
        "pool_asec_sources",
    ),
    "microcosm.build.us_runtime.capital_gain_details": (
        "CAPITAL_GAIN_DETAILS_ARCHIVED_DERIVATION_URL",
        "CAPITAL_GAIN_DETAILS_ARCHIVED_EXPORT_URL",
        "CAPITAL_GAIN_DETAILS_ARCHIVED_IMPUTATION_URL",
        "CAPITAL_GAIN_DETAILS_ARCHIVED_PERSON_ALLOCATION_URL",
    ...
    "microcosm.build.us_runtime.casualty_losses": (
        "US_CASUALTY_LOSS_NONCONSTANT_PERSON_COLUMNS",
        "US_CASUALTY_LOSS_OUTPUT_COLUMNS",
        "US_CASUALTY_LOSS_STAGE_NAME",
        "derive_us_casualty_loss_from_puf",
    ...
    "microcosm.build.us_runtime.congressional_district_vintage_crosswalk": (
        "CROSSWALK_BASIS_BLOCK_POPULATION",
        "build_cd_vintage_crosswalk_rows",
        "normalize_district_code",
        "parse_baf_cd_layer",
    ...
    "microcosm.build.us_runtime.cps_carried": (
        "CPS_CARRIED_FORMULA_OWNED_COLUMNS",
        "CPS_CARRIED_PERSON_INPUTS",
        "CPS_CARRIED_SPM_UNIT_INPUTS",
        "CPS_REPORTED_TANF_AMOUNT_RAW_COLUMN",
    ...
    "microcosm.build.us_runtime.demographics": (
        "AGE_BANDS",
        "DEMOGRAPHICS_SCHEMA_VERSION",
        "AgeBand",
        "compute_age_distribution",
    ...
    "microcosm.build.us_runtime.domestic_production": (
        "DOMESTIC_PRODUCTION_ALD_ARCHIVED_DERIVATION_URL",
        "DOMESTIC_PRODUCTION_ALD_ARCHIVED_EXPORT_URL",
        "DOMESTIC_PRODUCTION_ALD_ARCHIVED_IMPUTATION_URL",
        "DOMESTIC_PRODUCTION_ALD_ARCHIVED_PUF_ARTIFACT_URL",
    ...
    "microcosm.build.us_runtime.educator_expenses": (
        "EDUCATOR_EXPENSE_ARCHIVED_ALLOCATION_URL",
        "EDUCATOR_EXPENSE_ARCHIVED_DERIVATION_URL",
        "EDUCATOR_EXPENSE_ARCHIVED_EXPORT_URL",
        "EDUCATOR_EXPENSE_ARCHIVED_PUF_IMPUTATION_URL",
    ...
    "microcosm.build.us_runtime.farm_business_income": (
        "FARM_BUSINESS_INCOME_ARCHIVED_CPS_FARM_INCOME_URL",
        "FARM_BUSINESS_INCOME_ARCHIVED_DERIVATION_URL",
        "FARM_BUSINESS_INCOME_ARCHIVED_EXPORT_URL",
        "FARM_BUSINESS_INCOME_ARCHIVED_IMPUTATION_URL",
    ...
    "microcosm.build.us_runtime.fiscal_targets": (
        "SOI_VARIABLE_MAP",
        "US_FISCAL_LEDGER_PARITY_REGISTRY",
        "US_FISCAL_LEDGER_PARITY_REPORT",
        "US_FISCAL_MACRO_REALISM_BANDS",
    ...
    "microcosm.build.us_runtime.form_4952": (
        "FORM_4952_ARCHIVED_DERIVATION_URL",
        "FORM_4952_ARCHIVED_EXPORT_URL",
        "FORM_4952_ARCHIVED_IMPUTATION_URL",
        "FORM_4952_ARCHIVED_PERSON_ALLOCATION_URL",
    ...
    "microcosm.build.us_runtime.hours_worked": (
        "US_HOURS_WORKED_NONCONSTANT_PERSON_COLUMNS",
        "US_HOURS_WORKED_OUTPUT_COLUMNS",
        "US_HOURS_WORKED_POOL_EXCLUDED_COLUMNS",
        "US_HOURS_WORKED_POOL_OUTPUT_COLUMNS",
    ...
    "microcosm.build.us_runtime.input_mass": ("us_input_mass_totals",),
    ...
    "microcosm.build.us_runtime.misc_itemized": (
        "US_MISC_ITEMIZED_NONCONSTANT_PERSON_COLUMNS",
        "US_MISC_ITEMIZED_OUTPUT_COLUMNS",
        "US_MISC_ITEMIZED_STAGE_NAME",
        "derive_us_misc_itemized_from_puf",
    ...
    "microcosm.build.us_runtime.nonzero_shares": ("nonzero_share", "us_nonzero_shares"),
    "microcosm.build.us_runtime.operator_boundary": (
        "FORMULA_OWNED_SOURCE_COLUMNS",
        "PRE_ASSEMBLY_OPERATOR_OUTPUT_FAMILIES",
        "assert_operator_free_source_frame",
    ),
    ...
    "microcosm.build.us_runtime.parity_reference": (
        "ECPS_PARITY_KNOWN_GAPS_RESOURCE",
        "ECPS_PARITY_REFERENCE_RESOURCE",
        "EcpsParityReference",
        "EcpsParitySource",
    ...
    "microcosm.build.us_runtime.puf_donor_io": ("load_puf_tax_unit_donor",),
    ...
    "microcosm.build.us_runtime.puma_ladder_sources": (
        "assemble_us_puma_ladder",
        "parse_tract_to_puma_relationship",
    ),
    ...
    "microcosm.build.us_runtime.reform_coverage_smoke": (
        "us_reform_coverage_smoke_gate",
    ),
    "microcosm.build.us_runtime.reform_validation": (
        "REFORM_VALIDATION_SCHEMA_VERSION",
        "ReformValidationSpec",
        "in_sample_reform_specs",
        "load_default_reform_specs",
    ...
    "microcosm.build.us_runtime.register_consistency": (
        "us_register_consistency_gate",
        "us_register_contradictions",
    ),
    "microcosm.build.us_runtime.relationship_inputs": (
        "US_RELATIONSHIP_INPUTS_NONCONSTANT_PERSON_COLUMNS",
        "US_RELATIONSHIP_INPUTS_OUTPUT_COLUMNS",
        "US_RELATIONSHIP_INPUTS_REQUIRED_SOURCE_COLUMNS",
        "US_RELATIONSHIP_INPUTS_STAGE_NAME",
    ...
    "microcosm.build.us_runtime.release_target_parity": (
        "RED_LINE_COMPILED_FAMILIES",
        "US_TARGET_PARITY_FEED_FAMILIES_RESOURCE",
        "US_TARGET_PARITY_MANIFEST_RESOURCE",
        "TargetFamily",
    ...
    "microcosm.build.us_runtime.salt_refund_income": (
        "SALT_REFUND_ARCHIVED_DERIVATION_URL",
        "SALT_REFUND_ARCHIVED_EXPORT_URL",
        "SALT_REFUND_ARCHIVED_IMPUTATION_URL",
        "SALT_REFUND_ARCHIVED_PERSON_ALLOCATION_URL",
    ...
    "microcosm.build.us_runtime.source_coverage": (
        "CHRONICLE_US_SOURCE_COVERAGE_CONTRACT_COMMIT",
        "LEDGER_US_SOURCE_COVERAGE_CONTRACT_COMMIT",
        "US_SOURCE_COVERAGE",
        "hard_target_package_aliases",
    ...
    "microcosm.build.us_runtime.support_provenance": (
        "us_reported_coverage_vintage_signal_gate",
    ),
    ...
    "microcosm.build.us_runtime.validation_input_coverage": (
        "US_VALIDATION_PROVISION_INPUT_LEAVES",
        "ValidationInputLeaf",
        "assert_validation_leaf_registry_current",
        "us_source_stage_outputs",
...
_LAZY_EXPORTS = {
    name: (module, name) for module, names in _EXPORT_MODULES.items() for name in names
}
...
# Annotations preserve the public type surface without initializing lazy values.
US_DONORS: Mapping[str, DonorSpec]
US_STAGE_NAMES: tuple[str, ...]
US_SOURCE_MANIFEST: SourceManifest
US_SOURCE_STAGE_SPECS: tuple[SourceStageSpec, ...]
US_NONNEGATIVE_SOURCE_OUTPUTS: frozenset[str]
US_SUPPORT_SPINE_MANIFEST: SupportSpineManifest
US_SUPPORT_SPINE_SPEC: SupportSpineSpec
...
def _resolve_export(name: str):
    ...
    # Never hold our lock across Python's module import locks.
    value = getattr(import_module(module), attribute)
    with _EXPORT_LOCK:
        return globals().setdefault(name, value)


def _initialize_source_manifest() -> None:
    with _EXPORT_LOCK:
        if all(name in globals() for name in _SOURCE_EXPORTS):
            return
        manifest = globals().get("US_SOURCE_MANIFEST")
        if manifest is None:
            manifest = _load_us_source_manifest()
        values = {
            "US_SOURCE_MANIFEST": manifest,
            "US_SOURCE_STAGE_SPECS": manifest.stages,
            "US_NONNEGATIVE_SOURCE_OUTPUTS": frozenset(
                output
...
def _initialize_support_manifest() -> None:
    with _EXPORT_LOCK:
        if all(name in globals() for name in _SUPPORT_EXPORTS):
            return
        manifest = globals().get("US_SUPPORT_SPINE_MANIFEST")
        if manifest is None:
            manifest = _load_us_support_spine_manifest()
        values = {
            "US_SUPPORT_SPINE_MANIFEST": manifest,
            "US_SUPPORT_SPINE_SPEC": manifest.support_spine,
        }
        for name, value in values.items():
            globals().setdefault(name, value)
...
_SUPPORT_EXPORTS = ("US_SUPPORT_SPINE_MANIFEST", "US_SUPPORT_SPINE_SPEC")


def __getattr__(name: str):
    if name in _LAZY_EXPORTS:
        return _resolve_export(name)
    if name in ("US_DONORS", "US_STAGE_NAMES"):
        _initialize_plan()
    elif name in _SOURCE_EXPORTS:
        _initialize_source_manifest()
    elif name in _SUPPORT_EXPORTS:
        _initialize_support_manifest()
    else:
...
def _initialize_plan() -> None:
    if "US_DONORS" in globals() and "US_STAGE_NAMES" in globals():
        return
    ssi_take_up_ssa_source_url = _resolve_export("SSI_TAKE_UP_SSA_SOURCE_URL")
    us_adult_care_stage_name = _resolve_export("US_ADULT_CARE_STAGE_NAME")
    us_childcare_stage_name = _resolve_export("US_CHILDCARE_STAGE_NAME")
    us_child_support_stage_name = _resolve_export("US_CHILD_SUPPORT_STAGE_NAME")
    us_disability_benefits_stage_name = _resolve_export(
        "US_DISABILITY_BENEFITS_STAGE_NAME"
    )
    us_education_inputs_stage_name = _resolve_export("US_EDUCATION_INPUTS_STAGE_NAME")
    us_eligibility_inputs_stage_name = _resolve_export(
        "US_ELIGIBILITY_INPUTS_STAGE_NAME"
    )
    us_energy_subsidy_stage_name = _resolve_export("US_ENERGY_SUBSIDY_STAGE_NAME")
    us_hours_worked_stage_name = _resolve_export("US_HOURS_WORKED_STAGE_NAME")
    us_housing_inputs_stage_name = _resolve_export("US_HOUSING_INPUTS_STAGE_NAME")
    us_immigration_stage_name = _resolve_export("US_IMMIGRATION_STAGE_NAME")
    us_medicare_take_up_stage_name = _resolve_export("US_MEDICARE_TAKE_UP_STAGE_NAME")
    us_other_health_insurance_stage_name = _resolve_export(
        "US_OTHER_HEALTH_INSURANCE_STAGE_NAME"
    )
    us_pregnancy_stage_name = _resolve_export("US_PREGNANCY_STAGE_NAME")
    us_prior_year_income_stage_name = _resolve_export("US_PRIOR_YEAR_INCOME_STAGE_NAME")
    us_puf_support_stage_name = _resolve_export("US_PUF_SUPPORT_STAGE_NAME")
    us_relationship_inputs_stage_name = _resolve_export(
        "US_RELATIONSHIP_INPUTS_STAGE_NAME"
    )
    us_retirement_contribution_stage_name = _resolve_export(
        "US_RETIREMENT_CONTRIBUTION_STAGE_NAME"
    )
    us_retirement_distribution_stage_name = _resolve_export(
        "US_RETIREMENT_DISTRIBUTION_STAGE_NAME"
    )
    us_sipp_head_start_stage_name = _resolve_export("US_SIPP_HEAD_START_STAGE_NAME")
    us_snap_discretionary_exemption_stage_name = _resolve_export(
        "US_SNAP_DISCRETIONARY_EXEMPTION_STAGE_NAME"
    )
    ...
    us_ssi_take_up_stage_name = _resolve_export("US_SSI_TAKE_UP_STAGE_NAME")
    us_voluntary_filing_stage_name = _resolve_export("US_VOLUNTARY_FILING_STAGE_NAME")
    us_weeks_unemployed_stage_name = _resolve_export("US_WEEKS_UNEMPLOYED_STAGE_NAME")
    us_wic_claim_stage_name = _resolve_export("US_WIC_CLAIM_STAGE_NAME")
    us_workers_compensation_stage_name = _resolve_export(
        "US_WORKERS_COMPENSATION_STAGE_NAME"
    )
    with _EXPORT_LOCK:
        us_donors: Mapping[str, DonorSpec] = {
        ...
        globals().setdefault("US_DONORS", us_donors)
        globals().setdefault("US_STAGE_NAMES", us_stage_names)
...
def us_plan(
    ...
    """
    _initialize_plan()
    stage_names = globals()["US_STAGE_NAMES"]
    donors = globals()["US_DONORS"]
