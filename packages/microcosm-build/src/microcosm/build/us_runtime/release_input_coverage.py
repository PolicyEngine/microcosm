...
microcosm #368. The launch failure this closes: an SSI asset-limit reform scored
...
:func:`microcosm.build.us_runtime.l0_refit_export.assert_required_us_release_source_columns`
...
from microcosm.build.us_runtime.form_4952 import US_FORM_4952_OUTPUT_COLUMNS
from microcosm.build.us_runtime.housing_inputs import US_HOUSING_INPUTS_OUTPUT_COLUMNS
...
from microcosm.build.us_runtime.scf_wealth import US_SCF_NET_WORTH_OUTPUT_COLUMNS
...
from microcosm.build.us_runtime.ssi_take_up import US_SSI_TAKE_UP_OUTPUT_COLUMNS
...
POST_REFERENCE_ECPS_REQUIRED_INPUTS = frozenset(
    {
        ...
        *US_SSI_DISABILITY_CRITERIA_OUTPUT_COLUMNS,
        # PolicyEngine/microcosm#451 items 1-2: the CDCC adult-care leg
...
#: (microcosm#462 / #361 remedy): the direct route reported on Form 1040 line 7
...
def _degenerate_columns(
    ...
    Reuses :func:`microcosm.build.gates.default_valued_columns_gate`'s exact
    ...
    """
    from microcosm.build.gates import default_valued_columns_gate
