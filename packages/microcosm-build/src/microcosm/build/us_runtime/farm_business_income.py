...
Microcosm's shared weighted QRF replaces them only on the dedicated PUF support
...
not create or suppress either signed amount here.  This is deliberate Microcosm
