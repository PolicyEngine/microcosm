...
unemployment compensation when available.  Microcosm adds typed person weights
...
def fetch_asec_2023_weeks_unemployed_source(
    ...
    *,
    ...
    root = (
        ...
        else Path.home() / ".cache" / "microcosm" / "cps" / "asec_2023"
    )
    ...
    if not archive_path.exists():
        ...
        request = urllib.request.Request(
            ASEC_2023_WEEKS_UNEMPLOYED_ZIP_URL,
            headers={"User-Agent": "microcosm-build/asec-weeks-unemployed"},
        )
        try:
