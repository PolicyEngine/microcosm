...
(7 U.S.C. 2015(o)(6)) never fires — the SNAP half of microcosm #323.
...
exemption-usage reports is follow-up under microcosm #323.
...
def us_snap_discretionary_exemption_signal_gate(frame: Frame) -> GateResult:
    ...
    inverting) the nobody-is-ever-exempt failure of microcosm #323.
    """
