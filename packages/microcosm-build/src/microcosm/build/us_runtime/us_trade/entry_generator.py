...
ingested in :mod:`microcosm.build.us_runtime.us_trade.census_imports` are the only
...
(:mod:`microcosm.build.us_runtime.us_trade.cbp_entry_stats`). The generator assumes
