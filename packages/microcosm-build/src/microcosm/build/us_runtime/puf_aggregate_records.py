...
from microcosm.build.us_runtime.alimony import derive_us_alimony_from_puf
...
from microcosm.build.us_runtime.form_4952 import derive_us_form_4952_election_from_puf
from microcosm.build.us_runtime.misc_itemized import derive_us_misc_itemized_from_puf
...
_SOURCE_FIELD_ATTRIBUTES = {
    ...
    # AGI band (microcosm#515); compare this raw audit figure only with the sum
...
def load_default_puf_aggregate_disaggregation_spec() -> PufAggregateDisaggregationSpec:
    ...
    path = files("microcosm.build.us") / "puf_aggregate_record_disaggregation.json"
