...
capped at 20,000 rows using the archived target-balanced sampler.  Microcosm's
...
def fetch_sipp_2023_financial_asset_donor(
    ...
    *,
    ...
    The known archived-repository checkout and legacy Microcosm SIPP cache are
    ...
    if local_path is not None:
        ...
        candidates.extend(
            (
                ...
                / "storage"
                / _DONOR_FILENAME,
                Path.home() / ".cache" / "microcosm" / "sipp" / _DONOR_FILENAME,
            )
        )
