...
def test_us_coverage_is_exact_complete_and_honest(
    ...
    assert fields["configuration_field_count"] == 42_328
    assert fields["authored_normative_field_count"] == 32_555
    assert fields["resolved_binding_field_count"] == 9_773
    assert fields["consumed_field_count"] == 42_328
    ...
    assert fields["mode_counts"] == {
        "legacy_behavior": 14_119,
        "compiler_semantic": 27_758,
        "front_end_validation": 348,
        "identity_only": 103,
    }
    assert fields["generation0_effect_counts"] == {
        "legacy_behavior": 38_647,
        "no_generation0_effect": 3_681,
    }
    ...
    assert inventory["counts"]["tail_control_fields"] == 1_104
