...
def test_us_coverage_is_exact_complete_and_honest(
    ...
    assert fields["configuration_field_count"] == 42_545
    assert fields["authored_normative_field_count"] == 32_528
    assert fields["resolved_binding_field_count"] == 10_017
    assert fields["consumed_field_count"] == 42_545
    ...
    assert inventory["counts"]["producer_inputs"] == 2_751
