...
def test_us_coverage_is_exact_complete_and_honest(
    ...
    assert fields["configuration_field_count"] == 42_239
    assert fields["authored_normative_field_count"] == 32_458
    assert fields["resolved_binding_field_count"] == 9_781
    assert fields["consumed_field_count"] == 42_239
    ...
    assert fields["mode_counts"] == {
        "legacy_behavior": 14_071,
        "compiler_semantic": 27_711,
        "front_end_validation": 354,
        "identity_only": 103,
    }
    assert fields["generation0_effect_counts"] == {
        "legacy_behavior": 38_552,
        "no_generation0_effect": 3_687,
    }
    ...
    assert inventory["counts"]["producer_inputs"] == 2_743
