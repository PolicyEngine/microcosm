...
microcosm#495 increment 2. The rowwise clone consumes the national seam's
staging H5, whose ``microcosm_household_weight_kind`` and
``microcosm_mass_log_json`` attrs are part of the HMRC replay's fence chain
...
def test_dataset_object_metadata_carrier_is_retired() -> None:
    class SeamLike:
        time_period = "2023"
        household_weight_kind = WeightKind.IMPORTANCE
        mass_log = (
