...
def test_constants_adapter_equals_live_constants_and_stays_out_of_identities(
    ...
    assert run_config == {
        ...
        "spec_binding": {
            ...
            "schema_id": "country_spec",
            "schema_version": 1,
            "spec_sha256": "e8543c545aea4ccca71605c1504e0c6c843c8eee6c8fefaf858cb888a73dbcec",
        },
    }
...
def test_constants_adapter_fixture_checkpoints_are_byte_identical_and_only_receipt_changes(
    ...
    fixed_binding = {
        ...
        "schema_id": "country_spec",
        "schema_version": 1,
        "spec_sha256": "05edd87390d841c5b444267cd674d8bb15ed518b12577268d2e2c2de82976079",
    }
