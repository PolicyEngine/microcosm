"""Contract tests for the documented-absent-inputs register (microcosm #351/#249)."""
...
def test_every_entry_names_a_tracking_issue() -> None:
    ...
    for column, reason in builder.US_DOCUMENTED_ABSENT_INPUTS.items():
        assert re.search(r"PolicyEngine/microcosm#\d+", reason), (
...
def test_seeded_inputs_are_not_documented_as_absent() -> None:
    ...
    # adult_care_inputs stage (microcosm#451 item 1), which seeds it from
