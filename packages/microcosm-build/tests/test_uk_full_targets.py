...
def prepared(monkeypatch):
    ...
    monkeypatch.setattr(runtime, "load_uk_chronicle_feed", lambda: pin)
    monkeypatch.setattr(
        runtime,
...
def test_current_national_and_local_pins_share_one_reviewed_identity():
    ...
    assert (
        ...
        == local["source_commit"]
        == "5324aa27a7698eef97b38a7924a36b3a1f97c137"
    )
    assert national.fact_row_count == local["fact_row_count"] == 287024
