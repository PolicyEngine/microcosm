...
_CAPTURED_FEED = _TEST_PATHS.tests / "fixtures" / "uk_target_reference_feed_rows.jsonl"
...
def test_schema_id_membership_covers_every_real_producer_id() -> None:
    ...
    assert consumer_fact_schema_epoch(CHRONICLE_CONSUMER_FACT_SCHEMA_VERSION_V4) == (
        CHRONICLE_EPOCH
    )
