...
_US_PACKAGE_DIR = (
    _REPO_ROOT / "packages" / "microcosm-build" / "src" / "microcosm" / "build" / "us"
)
...
class TestJctObbbaAdjudication:
    """microcosm#451 items 3-4: the JCX-35-25 no-tax anchors' parity disposition.
    ...
    def test_build_manifest_adjudicates_an_injected_obbba_fact(self) -> None:
        ...
        fixtures_spec = importlib.util.spec_from_file_location(
            ...
            _TEST_PATHS.tests / "engine_free/us/test_us_fiscal_targets.py",
        )
