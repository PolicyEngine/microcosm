...
FIXTURE_FEED_ROWS = (
    _TEST_PATHS.tests / "fixtures" / "uk_target_reference_feed_rows.jsonl"
)
...
def test_uk_generator_averages_paid_monthly_sums_and_preserves_other_uc_operations() -> (
    ...
    # reference now declares an engine-index uprating, and the country's
    # appliers need the engine this test does not require.
    uc_contract = {
        **contract,
        "targets": [
            target
...
def test_two_level_targets_fan_out_over_the_region_tier() -> None:
    ...
    # SPI 2023-24 Table 3.11 by region: three measures by ten regional
    # total-income bands.
    spi_region = [
