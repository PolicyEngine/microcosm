...
from microcosm.build.us_runtime.hours_worked import US_HOURS_WORKED_OUTPUT_COLUMNS
from microcosm.build.us_runtime.immigration import US_IMMIGRATION_OUTPUT_COLUMNS
from microcosm.build.us_runtime.org_wages import US_ORG_WAGES_OUTPUT_COLUMNS
...
from microcosm.build.us_runtime.scf_auto_loans import US_SCF_AUTO_LOAN_OUTPUT_COLUMNS
from microcosm.build.us_runtime.sipp_head_start import (
    US_SIPP_HEAD_START_OUTPUT_COLUMNS,
)
from microcosm.build.us_runtime.sipp_tips import US_SIPP_TIPS_OUTPUT_COLUMNS
from microcosm.build.us_runtime.sipp_vehicles import US_SIPP_VEHICLE_OUTPUT_COLUMNS
from microcosm.build.us_runtime.snap_take_up import US_SNAP_TAKE_UP_OUTPUT_COLUMN
...
class TestKnownGapsRegister:
    ...
    def test_register_exempts_no_release_produced_layer(self) -> None:
        ...
        # contract marks as microcosm-produced), so an exemption for any of
    ...
    def test_legacy_auto_loan_gaps_are_retired(self) -> None:
