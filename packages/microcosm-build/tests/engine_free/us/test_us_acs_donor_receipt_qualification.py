"""Tests using shared support from ``test_support.microcosm_build.us_acs_donor_receipt_qualification``."""

# ruff: noqa: F403, F405
from test_support.microcosm_build.us_acs_donor_receipt_qualification import *
