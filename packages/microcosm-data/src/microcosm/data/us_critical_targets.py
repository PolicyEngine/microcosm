...
weaker hand-copied register than the publisher later enforces (microcosm#462).
"""
...
US_EXACT_CRITICAL_TARGET_FIT_REQUIREMENTS = (
    ...
    USCriticalTargetFitRequirement(
        ...
        # (microcosm#462, #488) re-equilibrated the solve and pushed medical
        # from certified M's +4.4% to +20.8%, stable across a 2x-epoch run.
        # Post-publish decomposition (microcosm#462, 2026-07-22): the national
        ...
        # owner doctrine (microcosm#492) forbids per-target loss knobs.
        # Relaxed to the established 0.25 broad-fit bound; restore
        # US_CRITICAL_DEDUCTION_MAX_ABS_RELATIVE_ERROR once the six-state
        # carriers are fixed (owners microcosm#481/#487) and a run holds 0.15
        # on truthful support.
    ...
    USCriticalTargetFitRequirement(
        ...
        # 2026-07-23 (microcosm#511 forensics): certified O-1 shipped this row
        ...
        # (microcosm#515). The capped column measured +15.0% at O-1 final
        ...
        # microcosm#515 lands and a run holds 0.15.
