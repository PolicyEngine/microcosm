...
serially to bound peak memory; the US job also streams host, process-tree, and
Linux control-group memory readings every five seconds and uploads the JSON
Lines trace.
The engine-free job
